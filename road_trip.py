...
price_per_gal = 3.25
distance = input("How far away (in miles) is your destination?: " +"/n")
...
print(f"On a single tank of gas, I can travel {full_tank_distance} miles /n")
...
print(f"With the {money:.2} I have and current cost of cost per gallon({price_per_gal:.2f} dollars per gallon), I can purchase {gal_I_can_buy:.2f}" + "/n")
...
print(f"The number of gallons I need to get my destinaation if my destination is {distance} miles away and fuel economy is {mpg} mpg, is {total_gallons}" + "/n")
...
print(f"The number of tanks I will need to make my trip if my tank max capacity is {tank_size} gallons and my trip distance is {distance} miles, it will be {tanks_needed} tanks."
      + "This means I would need to round {round(tanks_needed)} times for gas" + "/n")
...
#4. How much will the trip cost me?
def cal_trip_cost(gas_need, cost_per_gallon ):
     ''' 
